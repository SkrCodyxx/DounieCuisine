-- Script pour créer uniquement la table square_settings
...
-- Accorder les permissions à dounie_user
GRANT ALL PRIVILEGES ON square_settings TO dounie_user;
GRANT USAGE, SELECT ON SEQUENCE square_settings_id_seq TO dounie_user;